  ...
  return (
    <div className="relative flex flex-row w-full">
      ...
      {isMenuOpen && (
        <ul
          ref={menuRef}
          className="absolute z-10 w-2/3 top-10 bg-white border-2 rounded-b-md overflow-auto max-h-24"
        >
      ...
      <div
        onClick={toggleMenu}
        className="flex items-center justify-center w-12 px-4 py-3 bg-gray-200 hover:opacity-80 cursor-pointer border-2 rounded-r-md"
      >
